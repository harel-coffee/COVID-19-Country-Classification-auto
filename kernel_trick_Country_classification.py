...
frequency_vector_read_final = np.load("/alina-data1/sarwan/IEEE_BigData/Dataset/Complete_all_freq_vec_data_one_hot.npy")
...
for ind_reduced in range(len(frequency_vector_read_final)):
    if variant_orig[ind_reduced]=="USA" or variant_orig[ind_reduced]=="England" or variant_orig[ind_reduced]=="Germany" or variant_orig[ind_reduced]=="Denmark" or variant_orig[ind_reduced]=="Canada" or variant_orig[ind_reduced]=="Sweden"  or variant_orig[ind_reduced]=="Japan" or variant_orig[ind_reduced]=="Scotland" or variant_orig[ind_reduced]=="France"  or variant_orig[ind_reduced]=="Netherlands" or variant_orig[ind_reduced]=="Spain" or variant_orig[ind_reduced]=="Switzerland" or variant_orig[ind_reduced]=="Wales" or variant_orig[ind_reduced]=="Italy" or variant_orig[ind_reduced]=="India"  or variant_orig[ind_reduced]=="Belgium" or variant_orig[ind_reduced]=="Brazil" or variant_orig[ind_reduced]=="Ireland" or variant_orig[ind_reduced]=="Australia" or variant_orig[ind_reduced]=="Mexico" or variant_orig[ind_reduced]=="Slovenia"  or variant_orig[ind_reduced]=="Poland" or variant_orig[ind_reduced]=="Norway" or variant_orig[ind_reduced]=="Israel" or variant_orig[ind_reduced]=="Lithuania" or variant_orig[ind_reduced]=="Luxembourg" or variant_orig[ind_reduced]=="Finland":
