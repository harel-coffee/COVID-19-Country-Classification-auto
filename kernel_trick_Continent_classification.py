...
#data_str = "Complete_all_freq_vec_data_kmers.npy"
data_str = "Complete_all_freq_vec_data_one_hot.npy"
frequency_vector_read_final = np.load("/alina-data1/sarwan/IEEE_BigData/Dataset/" + data_str)

print("Data Name = ",data_str)
...
with open(read_path) as csv_file:
    ...
    for row in csv_reader:
        tmp = row
        variant_orig_tmp.append(tmp[5])
        
variant_orig = []
for country_ind in range(len(variant_orig_tmp)):
    tmp_1 = variant_orig_tmp[country_ind]
    tmp_3 = tmp_1.split("/")[1]
    variant_orig.append(tmp_3)
...
for ind_reduced in range(len(frequency_vector_read_final)):
    if variant_orig[ind_reduced]=="USA" or variant_orig[ind_reduced]=="Canada"  or variant_orig[ind_reduced]=="Mexico":
        freq_vec_reduced.append(frequency_vector_read_final[ind_reduced])
        int_variant_reduced.append(1)
        name_variant_reduced.append("North America")
    if variant_orig[ind_reduced]=="Japan" or variant_orig[ind_reduced]=="India" or variant_orig[ind_reduced]=="Israel":
        freq_vec_reduced.append(frequency_vector_read_final[ind_reduced])
        int_variant_reduced.append(2)
        name_variant_reduced.append("Asia")
    if variant_orig[ind_reduced]=="Australia":
        freq_vec_reduced.append(frequency_vector_read_final[ind_reduced])
        int_variant_reduced.append(3)
        name_variant_reduced.append("Australia")
    if variant_orig[ind_reduced]=="Brazil":
        freq_vec_reduced.append(frequency_vector_read_final[ind_reduced])
        int_variant_reduced.append(4)
        name_variant_reduced.append("South America")
    if variant_orig[ind_reduced]=="England" or variant_orig[ind_reduced]=="Germany" or variant_orig[ind_reduced]=="Denmark" or variant_orig[ind_reduced]=="Sweden"  or variant_orig[ind_reduced]=="Scotland" or variant_orig[ind_reduced]=="France"  or variant_orig[ind_reduced]=="Netherlands" or variant_orig[ind_reduced]=="Spain" or variant_orig[ind_reduced]=="Switzerland" or variant_orig[ind_reduced]=="Wales" or variant_orig[ind_reduced]=="Italy" or variant_orig[ind_reduced]=="Belgium" or variant_orig[ind_reduced]=="Ireland" or variant_orig[ind_reduced]=="Slovenia"  or variant_orig[ind_reduced]=="Poland" or variant_orig[ind_reduced]=="Norway" or variant_orig[ind_reduced]=="Lithuania" or variant_orig[ind_reduced]=="Luxembourg" or variant_orig[ind_reduced]=="Finland":
        freq_vec_reduced.append(frequency_vector_read_final[ind_reduced])
        int_variant_reduced.append(5)
        name_variant_reduced.append("Europe")
...
print(aq)
######################################################################
#tem_fre_vec = freq_vec_reduced[0:500]
#tmp_true_labels = int_variant_reduced[0:500]
#tmp_true_labels_orig = name_variant_reduced[0:500]
